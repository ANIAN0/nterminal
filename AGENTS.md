...
**修改代码前必须阅读 `PROJECT_RULES.md`。**

- 项目规则文件包含当前项目特有的目录结构、技术栈和修改注意事项。
- 项目知识库位于 `project-kb/code/`，按源码结构镜像维护。
- 修改代码前，先读取对应的代码文件说明文档。

## 11. 浏览器操作

**需要操作浏览器时，优先使用 playwright-cli 连接现有 Edge 浏览器。**

避免启动新的浏览器实例，直接连接用户已打开的 Edge：
